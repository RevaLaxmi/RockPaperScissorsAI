...
# Fonts
chakra_font = ImageFont.truetype("assets/fonts/RussoOne-Regular.ttf", 28)
russo_font_big = ImageFont.truetype("assets/fonts/RussoOne-Regular.ttf", 36)
russo_font_button = ImageFont.truetype("assets/fonts/RussoOne-Regular.ttf", 28)
...
while True:
    ...
    if keypoints is not None and not game_over and wait_frames == 0:
        ...
        # Player move prediction & stability check
        if len(sequence) == SEQUENCE_LENGTH:
            ...
            if player_move != "nothing":
                ...
                # Only when move is stable and AI has predicted
    ...
    def mouse_callback(event, x, y, flags, param):
        global player_score, ai_score, last_result_text, last_ai_move, last_stable_move
        global game_over, show_ai_now, wait_frames, ai_prediction_made
    ...
    # Handle frame-based delay between rounds
    if wait_frames > 0:
        wait_frames -= 1
